...
<head>
    ...
    <title>Gujarathi Cuisine Menu</title>
    <style>
        /* Add any necessary CSS styles here */
        /* For example, you can style the menu items */
        body {
            background-image: url('images/gjback.png'); /* Replace 'menuback.jpg' with your image file */
        ...
        /* Style the order and cancel button container */
        .button-container {
            text-align: center;
            margin-top: 20px;
        }
...
<body>
    <h1>Gujrathi Cuisine Menu</h1>

    <form method="post" action="gjbill.php">
        <div class="menu">
            <?php
            // Define an array containing food items, their prices, and image paths
            $menuItems = array(
                array("name" => "Dokhala", "price" => 95, "image" => "images/dokhala.jpg"),
                array("name" => "Khandavi", "price" => 165, "image" => "images/khandvi.jpg"),
                array("name" => "Jalebi Fafda", "price" => 90, "image" => "images/fafada.jpg"),
                array("name" => "Authentic Gujrathi Thali", "price" => 350, "image" => "images/gjthali.jpg"),
                array("name" => "Thepala", "price" => 75, "image" => "images/thepala.jpg"),
                array("name" => "Sev Tamata nu Shaak", "price" => 120, "image" => "images/sev.jpg"),
                array("name" => "Dabeli", "price" => 30, "image" => "images/Dabeli.jpeg"),
                array("name" => "Khakhara", "price" => 70, "image" => "images/khakhrajpg.jpeg"),
                array("name" => "Undhiyu", "price" => 120, "image" => "images/undhiyu.png"),
                array("name" => "Dal Dokhali", "price" => 250, "image" => "images/daldokhali.jpg"),
