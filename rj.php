...
<head>
    ...
    <title>Rajasthani Cuisine Menu</title>
    <style>
        /* Add any necessary CSS styles here */
        /* For example, you can style the menu items */
        body {
            background-image: url('images/rjback.jpg'); /* Replace 'menuback.jpg' with your image file */
...
<body>
    <h1>Rajasthani Cuisine Menu</h1>

    <form method="post" action="rjbill.php">
        <div class="menu">
            <?php
            // Define an array containing food items, their prices, and image paths
            $menuItems = array(
                array("name" => "Boondi Raita", "price" => 80, "image" => "images/bundiraita.jpg"),
                array("name" => "Malpua", "price" => 100, "image" => "images/malpua.jpg"),
                array("name" => "Ghevar", "price" => 200, "image" => "images/ghevar.jpg"),
                array("name" => "Authentic Rajasthani Thali", "price" => 300, "image" => "images/rjthali.jpg"),
                array("name" => "Gatte", "price" => 120, "image" => "images/gatte.jpg"),
                array("name" => "Mawa Kachori", "price" => 128, "image" => "images/mawakachori.jpg"),
                array("name" => "Dal Bati Churma", "price" => 190, "image" => "images/dalbati.jpg"),
                array("name" => "Kalakand", "price" => 120, "image" => "images/kalakand.jpg"),
                array("name" => "Churma", "price" => 60, "image" => "images/churma.png"),
                array("name" => "Mohanthal", "price" => 250, "image" => "images/Mohanthal.jpg"),
